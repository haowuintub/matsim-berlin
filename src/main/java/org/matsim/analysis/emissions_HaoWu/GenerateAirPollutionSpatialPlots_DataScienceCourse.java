...
public class GenerateAirPollutionSpatialPlots_DataScienceCourse {
    private static final Logger log = Logger.getLogger(GenerateAirPollutionSpatialPlots_DataScienceCourse.class);
...
/*    //smaller BoundingBox:
    ...
    //bigger BoundingBox:
    private static final double xMin = 4568425.109;
    private static final double yMin = 5798792.211;
    private static final double xMax = 4623332.399;
    private static final double yMax = 5842868.841;
    // haowu ***
    ...
    // haowu ***
    // Program Arguments:
    //baseCase: -dir scenarios/berlin-v5.5-1pct/input/emissions_HaoWu/output-berlin-v5.5-1pct_baseCase_100Iterations/ -runId berlin-v5.5-1pct -outDir /Users/haowu/Workspace/R/DataScience_HA2/Output_MATSim_Emission/BaseCase/
    //PlanA: -dir scenarios/berlin-v5.5-1pct/input/emissions_HaoWu/output-berlin-v5.5-1pct-subpop_PlanA_Version1_secondSuccessfulRun_100Iterations/ -runId berlin-v5.5-1pct -outDir /Users/haowu/Workspace/R/DataScience_HA2/Output_MATSim_Emission/PlanA/
    ...
    private GenerateAirPollutionSpatialPlots_DataScienceCourse() {

    }

    public static void main(String[] args) {

        GenerateAirPollutionSpatialPlots_DataScienceCourse plots = new GenerateAirPollutionSpatialPlots_DataScienceCourse();
