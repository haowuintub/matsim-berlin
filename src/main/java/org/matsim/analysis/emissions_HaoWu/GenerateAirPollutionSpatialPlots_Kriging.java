...
public class GenerateAirPollutionSpatialPlots_Kriging {
    private static final Logger log = Logger.getLogger(GenerateAirPollutionSpatialPlots_Kriging.class);
...
/*    //smaller BoundingBox:
    ...
    private GenerateAirPollutionSpatialPlots_Kriging() {

    }

    public static void main(String[] args) {

        GenerateAirPollutionSpatialPlots_Kriging plots = new GenerateAirPollutionSpatialPlots_Kriging();
    ...
    private void writeEmissions() {
        ...
        final String outputFile = outputDir + runId + ".emissionsgrid_Kriging25_biggerBoundingBox.csv";
